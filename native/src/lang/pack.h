...
//
// Buffers are owned by the pack; the lexicon and number automata are used in
// place (lang/lexicon.h), so the same code serves bytes read from a file, an
// mmap'd region or an Android asset.
